                                    ...
                                    <div className="grid grid-flow-row-dense grid-cols-1 sm:grid-cols-2 gap-4">
                                        <div className="mx-0">
                                            ...
                                            <textarea
                                                ...
                                                placeholder="Body"
                                                rows="3"
                                                className="rows-5 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                            />
                                            <InputError
